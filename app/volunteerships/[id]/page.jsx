...
export default function VolunteershipDetail() {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-[#23233a] p-10 rounded-2xl mt-10 shadow">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Community Clean-Up</h1>
      ...
      <h2 className="text-xl font-bold text-white mb-4">Applicants ({applicants.length})</h2>
      <div className="overflow-x-auto rounded-lg">
        <table className="w-full text-base mb-2">
          ...
          <tbody>
            {applicants.map((a, i) => (
              <tr key={i} className="border-b border-[#29294d] hover:bg-[#252540]">
        ...
        <div className="flex items-center justify-between text-sm text-[#b3b3c6] px-2 py-2">
