...
const Sidebar = () => {
  ...
  const links = [
    ...
    { name: 'Refund', href: '/dashboard/refund', icon: <FiFileText /> }, // Added Refund tab
  ...
  return (
    <>
                ...
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-2 rounded-lg w-full text-left transition ${
                    pathname.startsWith(link.href)
                      ...
                      : "text-[#b3b3c6] hover:bg-[#23233a] hover:text-white"
                  }`}
                >
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-[#1e1e2f] p-6 flex-col z-50 transform transition-transform duration-200 ${
